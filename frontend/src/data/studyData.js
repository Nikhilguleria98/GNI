    ...
    benefits: [
      {
        ...
        description:
          "Industry-standard laboratory equipment and tools.",
      },
      {
        title: "Hands-on Learning",
        description:
          "Practical experience through real-world experiments.",
      },
      {
        title: "Research Facilities",
        description:
          "Dedicated spaces for innovation and research activities.",
      },
      {
        title: "Safety Standards",
        description:
          "Well-maintained labs with proper safety protocols.",
      },
    ],
  },

  curriculum: {
    title: "What Makes Our Curriculum Unique?",
    benefits: [
      {
        title: "Industry Alignment",
        description:
          "Designed with industry experts and professionals.",
      },
      {
        title: "Live Projects",
        description:
      ...
      },
      {
        title: "Case Studies",
        description:
          "Learn through industry-based case discussions.",
      },
      {
        title: "Skill Development",
        description:
  ...
  placements: {
    ...
    benefits: [
      ...
      },
      {
        ...
        description:
          "Interview practice sessions with experts.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Opportunities with top recruiters and companies.",
      },
    ],
  },
    ...
    benefits: [
      {
        ...
        description:
          "Research in AI, ML, and intelligent systems.",
      },
      {
      ...
      },
      {
        title: "Healthcare",
        description:
          "Innovation in biotechnology and healthcare.",
      },
      {
        title: "Smart Technology",
        description:
          "Research in IoT and emerging technologies.",
      },
    ],
  },
