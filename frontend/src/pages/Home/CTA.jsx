    ...
    <>
      <section className="relative w-full overflow-hidden bg-cover bg-center bg-no-repeat py-12 sm:py-14 md:py-16 lg:py-20" style={{ backgroundImage: "url('/banner.png')" }}>
        ...
        <div className="relative z-10 mx-auto flex min-h-[170px] w-full max-w-4xl flex-col items-center justify-center px-5 text-center sm:min-h-[190px] sm:px-8 md:min-h-[210px] lg:min-h-[230px] lg:px-10">
          ...
          <h2 className="max-w-[850px] text-[30px] font-bold leading-[1.15] text-white sm:text-[38px] md:text-[42px] lg:text-[48px] xl:text-[50px]">
            ...
            <span>
              ...
              <span className="relative inline-block">
                ...
                <span className="absolute left-0 bottom-[-7px] h-[6px] w-full bg-[#ff9d00]" style={{ clipPath: "polygon(0 0, 100% 0, 88% 45%, 72% 65%, 55% 82%, 38% 92%, 20% 100%, 0 100%)" }}
                />
              </span>
            </span>
          </h2>
          ...
          {/* button */}
          <button type="button" onClick={() => setIsApplyOpen(true)} className="mt-4 min-w-[115px] rounded-[2px] bg-[#ff6b00] px-6 py-2 text-[14px] font-semibold text-white transition-all duration-300 hover:bg-[#e85f00] hover:shadow-lg sm:mt-5 sm:min-w-[125px] sm:px-7 sm:py-2.5 sm:text-[15px] md:text-[17px] lg:min-w-[135px] lg:text-[17px]">
            Apply Now
          </button>
