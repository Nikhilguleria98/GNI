    ...
    <>
      <section className="bg-orange-600">
        <div className="mx-auto flex max-w-7xl flex-col gap-7 px-5 py-10 sm:px-8 sm:py-12 md:flex-row md:items-center md:justify-between md:gap-10 lg:px-12 lg:py-14">
          ...
          {/* button */}
          <button type="button" onClick={() => setIsApplyOpen(true)} className="inline-flex w-fit shrink-0 items-center gap-2 rounded-full border border-white/30 bg-black px-6 py-3 text-[14px] font-bold text-white transition hover:bg-gray-900 sm:px-7 sm:py-3.5 sm:text-[15px] md:text-[16px]">
            Apply Now
