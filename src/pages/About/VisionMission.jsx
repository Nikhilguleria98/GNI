      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-12 sm:px-7 sm:py-14 md:px-8 md:py-16 lg:px-10 lg:py-20">
        ...
        <div className="mt-10 grid items-center gap-8 sm:mt-12 sm:grid-cols-[170px_1fr] sm:gap-8 md:mt-14 md:grid-cols-[190px_1fr] md:gap-10 lg:mt-16 lg:grid-cols-[210px_1fr] lg:gap-12">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="flex h-[105px] w-[105px] items-center justify-center rounded-full border-[3px] border-[#ff5b00] transition-transform duration-500 hover:scale-105 m:h-[115px] sm:w-[115px] md:h-[125px] md:w-[125px]">
                ...
                return (
                  <div key={item.title} className="relative">
                    <button
                      ...
                      className="group flex w-full items-start gap-4 text-left sm:gap-5"
                    >

                      {/* Number */}
                      <span
                        className={`relative z-10 flex h-[21px] w-[21px] shrink-0 items-center justify-center text-[10px] font-bold text-white transition-all duration-300 sm:h-[23px] sm:w-[23px] sm:text-[11px] ${
                          isActive
                            ? "scale-110 bg-[#ff5b00] shadow-[0_0_0_3px_rgba(255,91,0,0.15)]"
                            : "bg-[#ff7a26]"
                        }`}
                      >
                        {index + 1}
                      ...
                      <div className="flex-1">
                        <span
                          className={`block text-[15px] font-bold leading-tight transition-colors duration-300 sm:text-[16px] md:text-[17px] ${
                            isActive
                              ? "text-[#ff5b00]"
                              : "text-[#202020] group-hover:text-[#ff5b00]"
                          }`}
                        >
                          {item.title}
                        </span>
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-2 left-[9px] top-2 w-[2px] bg-[#ffb38d] sm:left-[10px]">
              ...
              <div
                className="absolute left-0 top-0 w-full rounded-full bg-[#ff5b00] transition-all duration-500 ease-out"
                style={{
                  height: `${(activeMission / (missionPoints.length - 1)) * 100}%`,
                }}
              />
            </div>
