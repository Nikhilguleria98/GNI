...
const slides = [
  ...
  },
  {
    ...
    image: "/choose.png",
    description:
      "GNI provides students with a modern learning environment focused on academic excellence, practical knowledge and professional development. With experienced faculty, modern infrastructure and industry-oriented education, students are encouraged to explore their potential and build confidence for their future careers.",
  },
  {
    title: "Our Vision",
    ...
    image: "/choose.png",
    description:
      "Our vision is to create an environment where students can learn, innovate and grow. GNI focuses on developing strong technical knowledge, professional skills, leadership qualities and responsible values so that students are well prepared to meet the challenges of a rapidly changing world.",
  },
];
        ...
        <div className="grid items-center gap-8 md:grid-cols-[0.95fr_1.05fr] md:gap-10 lg:grid-cols-[1fr_1fr] lg:gap-14">
          ...
          <div className="relative pr-10 sm:pr-12 md:pr-14">
            ...
            <button
              ...
              className="absolute right-0 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full text-[#333] transition-all duration-300 hover:bg-[#ff5b00] hover:text-white sm:h-10 sm:w-10 md:h-11 md:w-11"
            >
