import { FiCheckCircle, FiUsers, FiCalendar, FiArrowRight } from "react-icons/fi";
...
export default function CampusHero() {
    ...
    return (
        <section className="relative min-h-[420px] overflow-hidden sm:min-h-[500px] lg:min-h-[570px]">
            ...
            {/* background image */}
            <img src="https://images.unsplash.com/photo-1564981797816-1043664bf78d?auto=format&fit=crop&w=2000&q=85" alt="Guru Nanak Institutions Campus" className="absolute inset-0 h-full w-full object-cover" />
