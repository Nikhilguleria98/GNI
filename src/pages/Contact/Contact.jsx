        ...
        <div className="grid overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm lg:grid-cols-2">
          ...
          <div className="border-b border-gray-200 p-5 sm:p-7 lg:border-b-0 lg:border-r lg:p-8">
            ...
            <div className="mt-6 overflow-hidden rounded-md border border-gray-200">
              <iframe
                title="Jindal's Guru Nanak Institutions Location"
                src="https://www.google.com/maps?q=Jindal%27s%20Guru%20Nanak%20Institutions%2C%20Mullana%2C%20Ambala%2C%20Haryana&output=embed"
                className="h-[230px] w-full border-0 sm:h-[270px] lg:h-[285px]"
                loading="lazy"
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label
                    htmlFor="name"
                    className="mb-1.5 block text-[12px] font-semibold text-gray-700 sm:text-[13px] md:text-[14px]"
                  >
                  ...
                  <input
                    ...
                    required
                    className="h-10 w-full rounded-md border border-gray-200 px-3 text-[12px] outline-none transition placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-100 sm:h-11 sm:text-[13px] md:text-[14px]"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="Tell us about your inquiry - B.Tech programs, engineering colleges, admissions, etc."
                  required
                  minLength={10}
                  maxLength={500}
                  rows={5}
                  className="w-full resize-none rounded-md border border-gray-200 px-3 py-2.5 text-[12px] leading-5 outline-none transition placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-100 sm:text-[13px] sm:leading-6 md:text-[14px]"
                />
              ...
              <button
                type="submit"
                className="inline-flex items-center gap-2 rounded-md bg-orange-600 px-6 py-3 text-[12px] font-semibold text-white transition hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-300 sm:px-7 sm:py-3.5 sm:text-[13px] md:text-[14px]"
              >
                <FiSend size={16} />
                Send Message
              </button>
