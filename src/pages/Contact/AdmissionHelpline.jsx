          ...
          <div className="group flex min-h-[105px] items-start gap-4 border border-gray-100 bg-white px-5 py-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:px-6 sm:py-6">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-2 flex flex-col gap-1">
                ...
                <a
                  href="tel:+919996500140"
                  className="w-fit text-[12px] leading-5 text-blue-600 underline underline-offset-2 transition-colors hover:text-orange-600 sm:text-[13px] sm:leading-6 md:text-[15px]"
                >
                  +91-99965-00140
                </a>

                <a
                  href="tel:+919996600140"
                  className="w-fit text-[12px] leading-5 text-blue-600 underline underline-offset-2 transition-colors hover:text-orange-600 sm:text-[13px] sm:leading-6 md:text-[15px]"
                >
                  +91-99966-00140
                </a>
          ...
          <div className="group flex min-h-[105px] items-start gap-4 border border-gray-100 bg-white px-5 py-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md sm:px-6 sm:py-6">
            ...
            <div className="min-w-0">
              ...
              <a
                ...
                className="mt-2 block w-fit break-all text-[12px] leading-5 text-blue-600 underline underline-offset-2 transition-colors hover:text-orange-600 sm:text-[13px] sm:leading-6 md:text-[15px]"
              >
                info@gni.edu.in
              </a>
