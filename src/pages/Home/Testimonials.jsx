          ...
          {testimonials.map((testimonial, index) => {
            ...
            return (
              <article
                ...
                className={`group cursor-pointer rounded-[16px] border border-[#ff7a00] bg-[#eef2ff] px-5 pb-5 pt-3 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)] sm:px-5 md:px-6 lg:px-5 ${
                  isActive
                    ? "shadow-[0_5px_15px_rgba(255,122,0,0.08)]"
                    : ""
                }`}
              >
      ...
      <div className="mt-5 flex items-center justify-center gap-[6px]">
        {testimonials.map((testimonial, index) => (
          <button
            ...
            className={`h-[8px] w-[8px] rounded-full transition-all duration-300 sm:h-[9px] sm:w-[9px] ${
              activeIndex === index
                ? "bg-[#f97316]"
                : "bg-[#f5b99a]"
            }`}
